...
function updateBreadcrumbSec(newItemName, newItemPath) {
  ...
  router.push({ path: `/${newItemPath}`, query: { loginId: loginId.value } });
}
            ...
            <el-sub-menu index="1">
              ...
              <el-menu-item-group>
                <el-menu-item
                  ...
                  @click="
                    () =>
                      updateBreadcrumbSec('项目申报', 'member/project/apply')
                  "
                  >我的项目</el-menu-item
                >
              </el-menu-item-group>
            ...
            <el-sub-menu index="2">
              ...
              <el-menu-item-group>
                <el-menu-item
                  index="2-1"
                  @click="
                    () => updateBreadcrumbSec2('任务内容', 'member/tasks/task')
                  "
                  >任务内容</el-menu-item
                >
              </el-menu-item-group>
            ...
            <el-sub-menu index="4">
              ...
              <el-menu-item-group>
                <el-menu-item
                  index="4-1"
                  @click="
                    () => updateBreadcrumbSec4('成果', 'member/achieve/result')
                  "
                  >查看成果</el-menu-item
                >
              </el-menu-item-group>
